...
a/1,a/0,b/1,b/0,c/1,c/0,d>0/0,z=1|e/0,h|e/0,h/0,d/1,d/0,f/1,f/0,g/0.
...
r1@ start, a(ID) , b(ID1), c(ID2) ==> d>0, z=1| match(r1,1,[ID, ID1, ID2]).
r2@ start, a(ID) , b(ID1), c(ID2) ==> h |  match(r2,1,[ID, ID1, ID2]).
...
a(ID),b(ID1)\c(ID2),history(L),fire,match(r1,_,[ID, ID1, ID2]) <=> d>0, z=1|e, history([(r1,[ID, ID1, ID2])|L]),start.
a(ID),b(ID1),c(ID2)\history(L),fire,match(r2,_,[ID, ID1, ID2]) <=> h|e, h, history([(r2,[ID, ID1, ID2])|L]),start.
